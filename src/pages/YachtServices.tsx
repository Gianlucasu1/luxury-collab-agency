...
const YachtServices = () => {
  ...
  const faqs = Array.from({ length: 5 }, () => ({
    q: 'What is the process of renting a yacht with TLCA?',
  ...
  return (
    <div className="min-h-screen bg-[#11353e] relative">
      ...
      <section className="relative w-full h-screen overflow-hidden">
        <div className="absolute inset-0 bg-cover" style={{ backgroundImage: `url(${yachtHero})`, backgroundPosition: 'center right' }} />
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="max-w-3xl">
              ...
              >
                Luxury Yachts
                <br />
                <span className="text-[#efb958]">and sailing</span>
              </h1>
              <p
              ...
              <a href="#yachts" className="inline-block mt-8 px-8 py-4 premium-cta font-secondary">
                Explore Yachts
              </a>
            </div>
          </div>
      ...
      <section
        ref={gridRef}
        id="yachts"
        className="relative pt-24 md:pt-28 lg:pt-32 pb-16 md:pb-20 lg:pb-24"
        style={{
      ...
      >
                ...
                <div className="flex items-center gap-3 text-white/90 font-secondary text-sm">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 w-full">
                    ...
                    <div className="relative">
                      <select 
                        className="w-full appearance-none rounded-md bg-white text-[#11353e] px-3 py-2 text-sm border border-white/60 outline-none focus:ring-2 focus:ring-[#efb958] shadow-md"
                        onFocus={() => handleSelectFocus('yachtName')}
                        onBlur={() => handleSelectBlur('yachtName')}
                        onChange={(e) => handleSelectChange('yachtName', e)}
                      >
                      ...
                      <ChevronDown 
                        size={16} 
                        className={`pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-[#11353e]/70 transition-transform duration-200 ${
                          openSelects.has('yachtName') ? 'rotate-180' : ''
                        }`} 
                      />
                    </div>
                    <div className="relative">
                      <select 
                        className="w-full appearance-none rounded-md bg-white text-[#11353e] px-3 py-2 text-sm border border-white/60 outline-none focus:ring-2 focus:ring-[#efb958] shadow-md"
                        onFocus={() => handleSelectFocus('yachtType')}
                        onBlur={() => handleSelectBlur('yachtType')}
                        onChange={(e) => handleSelectChange('yachtType', e)}
                      >
                      ...
                      <ChevronDown 
                        size={16} 
                        className={`pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-[#11353e]/70 transition-transform duration-200 ${
                          openSelects.has('yachtType') ? 'rotate-180' : ''
                        }`} 
                      />
                    </div>
                    <div className="relative">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {yachts.map((y) => (
              <Link to={`/yacht/${y.id}`} key={y.id} className="block rounded-2xl overflow-hidden shadow-xl focus:outline-none focus:ring-2 focus:ring-[#efb958]">
