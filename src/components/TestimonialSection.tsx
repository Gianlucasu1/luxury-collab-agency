...
const TestimonialSection = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-[#11353e] to-background">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-primary font-bold text-foreground mb-6">
            What Our <span className="text-[#efb958]">Clients</span> Say
          </h2>
        ...
        <div className="relative max-w-7xl mx-auto h-[600px] flex items-center justify-center overflow-hidden perspective-1000">
          ...
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            <div className="glass-panel rounded-2xl p-8 w-80 text-center relative">
              <div className="absolute top-6 left-6 opacity-10">
                <Quote className="w-12 h-12 text-[#efb958]" />
              </div>
              
              <div className="relative z-10">
                <div className="flex justify-center mb-4">
                  {[...Array(testimonials[getTestimonialIndex(-1)].rating)].map((_, i) => (
                    <svg key={i} className="w-4 h-4 text-[#efb958] mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="border-t border-accent/20 pt-4">
                  <h4 className="text-lg font-primary font-semibold text-[#efb958] mb-1">
            ...
            <div className="glass-panel rounded-2xl p-12 w-[500px] max-w-[90vw] text-center relative shadow-2xl border border-accent/10">
              <div className="absolute top-8 left-8 opacity-10">
                <Quote className="w-16 h-16 text-[#efb958]" />
              </div>
              
              <div className="relative z-10">
                <div className="flex justify-center mb-6">
                  {[...Array(testimonials[currentTestimonial].rating)].map((_, i) => (
                    <svg key={i} className="w-6 h-6 text-[#efb958] mr-1" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  ))}
                </div>
                ...
                <div className="border-t border-accent/20 pt-6">
                  <h4 className="text-xl font-primary font-semibold text-[#efb958] mb-1">
          ...
          >
            <ChevronLeft className="w-8 h-8 text-[#efb958]" />
          </button>
          ...
          >
            <ChevronRight className="w-8 h-8 text-[#efb958]" />
          </button>
        </div>
