    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="flex flex-col items-center justify-center text-center">
          <h2 className="text-3xl md:text-4xl font-primary font-bold text-white mb-4 drop-shadow-lg"><span className="text-[#efb958]">Subscribe</span> to Our Luxury Blog</h2>
